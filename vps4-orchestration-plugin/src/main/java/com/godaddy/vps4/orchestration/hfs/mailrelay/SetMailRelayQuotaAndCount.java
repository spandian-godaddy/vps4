...
public class SetMailRelayQuotaAndCount implements Command<SetMailRelayQuotaAndCount.Request, Void> {
    ...
    @Inject
    public SetMailRelayQuotaAndCount(MailRelayService mailRelayService) {
