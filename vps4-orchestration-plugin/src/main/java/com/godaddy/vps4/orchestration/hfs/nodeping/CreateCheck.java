...
public class CreateCheck implements Command<CreateCheck.Request, NodePingAction> {
    ...
    @Override
    public NodePingAction execute(CommandContext context, CreateCheck.Request request) {
