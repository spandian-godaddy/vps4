...
import com.godaddy.vps4.orchestration.hfs.nodeping.DeleteCheck;
import com.godaddy.vps4.orchestration.hfs.nodeping.WaitForNodePingAction;
...
public class HfsCommandModule extends AbstractModule {
    ...
    public void configure() {
        ...
        bind(WaitForNodePingAction.class);
    }
}
