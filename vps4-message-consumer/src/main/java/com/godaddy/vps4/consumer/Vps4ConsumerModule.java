...
import com.godaddy.vps4.handler.Vps4MonitoringMessageHandler;
...
public class Vps4ConsumerModule extends AbstractModule {
    ...
    public void configure() {
        ...
        bind(MessageHandler.class).annotatedWith(Names.named("Monitoring")).to(Vps4MonitoringMessageHandler.class).in(Scopes.SINGLETON);
