...
BEGIN
    ...
    INSERT INTO virtual_machine (vm_id, orion_guid, name, project_id, spec_id, image_id, data_center_id, current_os)
    VALUES (p_vm_id, p_orion_guid, p_name, v_project_id, v_spec_id, v_image_id, p_data_center_id, v_current_os);
