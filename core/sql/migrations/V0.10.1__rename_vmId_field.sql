...
BEGIN
    ...
    INSERT INTO virtual_machine (id, hfs_vm_id, orion_guid, name, project_id, spec_id, managed_level, image_id)
       VALUES (p_id, p_hfs_vm_id, p_orion_guid, p_name, p_project_id, p_spec_id, p_managed_level, p_image_id);
