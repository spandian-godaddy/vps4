CREATE OR REPLACE FUNCTION get_or_create_user(p_shopper_id TEXT, p_reseller_id TEXT)
...
BEGIN
    ...
    IF NOT FOUND THEN
        BEGIN
            INSERT INTO vps4_user (shopper_id, reseller_id) VALUES (p_shopper_id, p_reseller_id)
