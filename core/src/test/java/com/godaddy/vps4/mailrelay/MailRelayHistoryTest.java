...
public class MailRelayHistoryTest {
    ...
    public void setUp(){
        ...
        when(hfsRelayService.getRelayHistory("1.2.3.4")).thenReturn (relayHistory);
    ...
    public void testGetMailRelay(){
        ...
        when(mailRelayHistoryCache.get("1.2.3.4")).thenReturn(null);
        List<MailRelayHistory> result = relayService.getMailRelayHistory("1.2.3.4", false);
        verify(hfsRelayService, times(1)).getRelayHistory("1.2.3.4");
    ...
    public void testGetCachedMailRelay(){
        ...
        when(mailRelayHistoryCache.get("1.2.3.4")).thenReturn(cachedHistory);
        List<MailRelayHistory> result = relayService.getMailRelayHistory("1.2.3.4", false);
        verify(hfsRelayService, times(0)).getRelayHistory("1.2.3.4");
    ...
    public void testGetCachedMailRelayForceRefresh(){
        ...
        CachedMailRelayHistory cachedHistory = new CachedMailRelayHistory();
        when(mailRelayHistoryCache.get("1.2.3.4")).thenReturn(cachedHistory);
        List<MailRelayHistory> result = relayService.getMailRelayHistory("1.2.3.4", true);
        verify(hfsRelayService, times(1)).getRelayHistory("1.2.3.4");
        Assert.assertEquals(this.relayHistory, result);
    }
