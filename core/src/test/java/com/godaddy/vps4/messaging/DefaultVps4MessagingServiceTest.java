...
public class DefaultVps4MessagingServiceTest {
    ...
    public void testBuildShopperMessageJson() {
        try {
            ...
            shopperMessage.templateTypeKey =
    ...
    public void testBuildScheduledMaintenanceJson() {
        try {
            ...
            Method buildScheduledMaintenanceJson =
                    messagingService.getClass().getDeclaredMethod("buildScheduledMaintenanceJson", args);
            buildScheduledMaintenanceJson.setAccessible(true);
            String shopperMessageJsonResult = (String)buildScheduledMaintenanceJson.invoke(messagingService, emailTemplate, accountName, startTime, durationMinutes, isManaged);
            Assert.assertEquals(SecureHttpClient.createJSONStringFromObject(shopperMessage), shopperMessageJsonResult);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public void testBuildFailoverJson() {
        try {
            ...
            String shopperMessageJsonResult =
                    (String) buildFailoverJson.invoke(messagingService, emailTemplate, accountName, isManaged);
            Assert.assertEquals(SecureHttpClient.createJSONStringFromObject(shopperMessage), shopperMessageJsonResult);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    @Test
    public void testSendUptimeOutageEmail() throws IOException {
    ...
    @Test
    public void testSendServerUsageOutageEmail() throws IOException {
        Instant alertStart = Instant.now();
        when(secureHttpClient.executeHttp(Mockito.any(HttpPost.class), Mockito.any())).thenReturn(mockMessageId);
        String actualMessageId = messagingService
    ...
    @Test
    public void testSendServicesDownEmail() throws IOException {
        Instant alertStart = Instant.now();
        when(secureHttpClient.executeHttp(Mockito.any(HttpPost.class), Mockito.any())).thenReturn(mockMessageId);
        String actualMessageId = messagingService
    ...
    @Test
    public void testSendUptimeOutageResolvedEmail() throws IOException {
    ...
    @Test
    public void testSendServerUsageOutageResolvedEmail() throws IOException {
        Instant alertEnd = Instant.now();
        when(secureHttpClient.executeHttp(Mockito.any(HttpPost.class), Mockito.any())).thenReturn(mockMessageId);
        String actualMessageId = messagingService
    ...
    @Test
    public void testSendServicesRestoredEmail() throws IOException {
        Instant alertEnd = Instant.now();
        when(secureHttpClient.executeHttp(Mockito.any(HttpPost.class), Mockito.any())).thenReturn(mockMessageId);
        String actualMessageId = messagingService
