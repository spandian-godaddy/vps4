...
public class JsdClientResponseFilter implements ClientResponseFilter {

    private static final Logger logger = LoggerFactory.getLogger(JsdClientResponseFilter.class);
