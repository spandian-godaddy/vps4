...
public interface PanoptaDataService {
    void createOrUpdatePanoptaCustomer(String shopperId, String customerKey);
    ...
    void insertPanoptaServer(UUID vmId, String shopperId, long serverId, String serverKey, String templateId);
