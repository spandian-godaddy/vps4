...
public class ProdMeta {
    ...
    public ProdMeta(UUID entitlementId, 
                    DataCenter dataCenter, 
                    UUID productId, 
                    Instant provisionDate, 
    ...
    public ProdMeta(Map<ProductMetaField, String> productMeta, DataCenterService dataCenterService) {
        if (isKeyParseable(productMeta, ProductMetaField.DATA_CENTER)) {
            this.dataCenter = dataCenterService.getDataCenter(Integer.parseInt(productMeta.get(ProductMetaField.DATA_CENTER)));
        }
    ...
    public Map<ProductMetaField, Object> getProdMetaMap() {
        ...
        if(dataCenter != null) fields.put(ProductMetaField.DATA_CENTER, dataCenter);
