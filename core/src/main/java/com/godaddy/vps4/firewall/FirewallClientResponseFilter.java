...
public class FirewallClientResponseFilter implements ClientResponseFilter {

    private static final Logger logger = LoggerFactory.getLogger(FirewallClientResponseFilter.class);
