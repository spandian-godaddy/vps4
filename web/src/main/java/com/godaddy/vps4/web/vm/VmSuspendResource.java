...
public class VmSuspendResource {
    ...
    @Inject
    public VmSuspendResource(GDUser user, VmResource vmResource, CreditService creditService, ActionService actionService,
                             CommandService commandService, VmActionResource vmActionResource, VirtualMachineService virtualMachineService) {
        this.user = user;
