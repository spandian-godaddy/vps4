...
public class CreateTestVmRequest {
    ...
    protected void provision(int tier, int managedLevel, int monitoring, String operatingSystem, String controlPanel, String shopperId) {

        UUID orionGuid = UUID.randomUUID();
        creditService.createVirtualMachineCredit(orionGuid, operatingSystem, controlPanel, tier, managedLevel, monitoring, shopperId);
    ...
    public static void main(String[] args) {
        ...
        force.provision(10, 0, 0, "centos-7", "cpanel", shopperId);
    }
