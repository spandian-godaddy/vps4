...
public class ImportedVmFilterTest {
    ...
    @Test
    public void testVmApiCreateOhBackupImportedVm() throws Exception {
        when(request.getRequestURI()).thenReturn("/api/vms/" + importedVmId + "/ohBackups");
        when(request.getMethod()).thenReturn("POST");
    ...
    @Test
    public void testVmApiMergeShopperImportedVm() throws Exception {
        when(request.getRequestURI()).thenReturn("/api/vms/" + importedVmId + "/mergeShopper");
        when(request.getMethod()).thenReturn("POST");
    ...
    @Test
    public void testVmApiEndRescueImportedVm() throws Exception {
        when(request.getRequestURI()).thenReturn("/api/vms/" + importedVmId + "/endRescue");
        when(request.getMethod()).thenReturn("POST");
    ...
    @Test
    public void testVmApiUpgradeImportedVm() throws Exception {
        when(request.getRequestURI()).thenReturn("/api/vms/" + importedVmId + "/upgrade");
        when(request.getMethod()).thenReturn("POST");
