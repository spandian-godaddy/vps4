...
public class Vps4ZombieCleanupTriggerListener extends SchedulerTriggerListener {
    private static final Logger logger = LoggerFactory.getLogger(Vps4ZombieCleanupTriggerListener.class);
