...
public class Vps4CancelAccountTriggerListener extends SchedulerTriggerListener {
    private static final Logger logger = LoggerFactory.getLogger(Vps4CancelAccountTriggerListener.class);
